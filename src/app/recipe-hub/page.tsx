...
export default function RecipeHubPage() {
  return (
    <main className="min-h-screen bg-background">
      <Header />
      <div className="container mx-auto px-4 pt-16 sm:pt-20 py-12 sm:py-20">
        <div className="text-center max-w-2xl mx-auto">
          <h1 className="font-headline text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 sm:mb-6">
